...
export default function MessagesScreen() {
  useScreenTracking('ProviderMessages');
  const { user } = useAuth();
  ...
  const renderEmptyState = () => (
    ...
    >
      ...
      <Text style={styles.emptyText}>Your inbox is empty... for now!</Text>
      <View style={styles.emptyInfoBox}>
        <Text style={styles.emptyInfoTitle}>💡 What you'll see here:</Text>
        <View style={styles.emptyInfoItem}>
          <Ionicons name="checkmark-circle" size={20} color={colors.success} />
          <Text style={styles.emptyInfoText}>Booking confirmations</Text>
        </View>
        <View style={styles.emptyInfoItem}>
          <Ionicons name="checkmark-circle" size={20} color={colors.success} />
          <Text style={styles.emptyInfoText}>Customer questions</Text>
        </View>
        <View style={styles.emptyInfoItem}>
          <Ionicons name="checkmark-circle" size={20} color={colors.success} />
          <Text style={styles.emptyInfoText}>Appointment updates</Text>
        </View>
      </View>
      <Text style={styles.emptySubtext}>
        Messages will appear here after customers book your services
      </Text>
    </Animated.View>
  );
