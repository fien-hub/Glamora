...
try { DateTimePicker = require('@react-native-community/datetimepicker').default; } catch (e) { console.warn('[CustomerNotificationSettings] datetimepicker unavailable:', e); }
